...
- Implemented Capability 002.6: immutable Resume Semantic Graph Runs that reuse 002.5 candidates, preserve artifact/version/span provenance, and expose bounded graph evidence to Discovery without writing Candidate Knowledge.
