...
The Demo defaults to graph-free `resume_ast` retrieval. Semantic graph construction is explicit/lazy (`--build-semantic-graph`). This preserves 003.6 as the sole Candidate Knowledge writer.
